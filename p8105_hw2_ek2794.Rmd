...
With our cleaned file, mrtrash_df is the cleaned up Mr. Trash Wheel Sheet and professor_trashwheel_df is the cleaned up Professor Trashwheel Sheet that now both have 15 variables that include the role (mr or professor labels with line row), dumpster number, month, year, date (in the prior annotation of `year`-`month`-`day`), weight_tons, volume in cubic yards, plastic bottles, polystyrene, cigarette butts, glass bottles, grocery bags, chips bags, sports balls, and home powered. 
